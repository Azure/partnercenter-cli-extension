...
from partnercenter.azext_partnercenter._client_factory import cf_package


def load_command_table(commands_loader, _):
    custom_command_type = CliCommandType(operations_tmpl='azext_partnercenter.operations.marketplace_offer_package.custom#{}', client_factory=cf_package)
