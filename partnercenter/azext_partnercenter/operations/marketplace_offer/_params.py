...
def load_arguments(commands_loader, _):
    ...
    with commands_loader.argument_context('partnercenter marketplace offer delete') as c:
        c.argument('product_id', options_list=['--product_id', '-p'], help='Product or offer ID to delete')