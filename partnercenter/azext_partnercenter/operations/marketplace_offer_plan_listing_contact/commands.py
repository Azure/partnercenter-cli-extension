...
def load_command_table(commands_loader, _):
    ...
    with commands_loader.command_group('partnercenter marketplace offer plan listing contact', custom_command_type, is_preview=True) as g:
        ...
        g.custom_command('delete', 'marketplace_offer_plan_listing_contact_delete', confirmation=True, custom_command_type=custom_command_type)
        g.generic_update_command('update',
                                    ...
                                    custom_func_name='marketplace_offer_plan_listing_contact_update_custom',
