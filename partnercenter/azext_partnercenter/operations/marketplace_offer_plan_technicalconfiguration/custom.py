...
def marketplace_offer_plan_technicalconfiguration_update_get(cmd, client, external_id, product_external_id, description=None, short_description=None, language_code=None):
    plan_listing = client.get_plan_listing(product_external_id, external_id)
    return plan_listing
    
def marketplace_offer_plan_technicalconfiguration_update_set(cmd, client, external_id, product_external_id, description=None, short_description=None, language_code=None, parameters=None):
...
def marketplace_offer_plan_technicalconfiguration_update_custom(instance, external_id, product_external_id, description=None, short_description=None, language_code=None):
