...
def load_arguments(commands_loader, _):
    ...
    with commands_loader.argument_context('partnercenter marketplace offer plan technical-configuration package add') as c:
        ...
        c.argument('public_azure_tenant_id', options_list=['--public-azure-tenant-id'], help='The public Azure Tenant ID of the account that will managed the package')
        c.argument('public_azure_authorization_principal', options_list=['--public-azure-authorization-principal'], help='The principal that will managed the package when deployed to public Azure')
        c.argument('public_azure_authorization_role', options_list=['--public-azure-authorization-role'], help='The role the principal will take when managing the package')
