...
def load_arguments(commands_loader, _):
    ...
    with commands_loader.argument_context(
        ...
        c.argument(
            "cluster_extension_type", options_list=["--cluster-extension-type"], help="The Cluster Extension Type"
        )
        c.argument("tenant_id", arg_group="CNAB Resource", options_list=["--tenant-id", "-t"], help="The AAD tenant ID")
        c.argument(
            "subscription_id",
            arg_group="CNAB Resource",
        ...
        c.argument(
            ...
            help="The Resource Group name for the Azure Container Registry",
        )
        c.argument(
            "registry_name",
            arg_group="CNAB Resource",
        ...
        c.argument(
            ...
            help="The name of the image repository in the Azure Container Registry.",
        )
        ...
        c.argument(
            ...
            arg_group="CNAB Resource",
            options_list=["--digest"],
            help="The digest of the bundle with a format of sha256:<hashcode>",
        )
